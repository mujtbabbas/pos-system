...
<head>
    <meta charset="utf-8">
    <base href="<?= base_url() ?>">
    <title><?= esc($config['company']) . ' | ' . lang('Common.powered_by') . ' SaleMatePOS ' . esc(config('App')->application_version) ?></title>
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="<?= site_url() ?>">SaleMate POS</a>
                </div>
