...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#currency_symbol, #thousands_separator, #currency_code').change(function() {
            ...
            $.post("<?= "$controller_name/checkNumberLocale" ?>",
                ...
                function(response) {
                    ...
                    // Don't overwrite currency fields - let user maintain their custom values
        ...
        // Add separate handler for number_locale changes only
        $('#number_locale').change(function() {
            var currentSymbol = $('#currency_symbol').val();
            var currentCode = $('#currency_code').val();
            
            var data = {
                number_locale: $(this).val(),
                save_number_locale: $("input[name='save_number_locale']").val(),
        ...
        $('#locale_config_form').validate($.extend(form_support.handler, {
                ...
                number_locale: {
                    ...
                    remote: {
                        ...
                        dataFilter: function(data) {
                            ...
                            // Don't overwrite currency fields during validation
                            // Only update the example display
                            // $('#currency_symbol').val(response.currency_symbol);
                            // $('#currency_code').val(response.currency_code);
            ...
            messages: {
                number_locale: {
                    ...
                    remote: "<?= lang('Config.number_locale_invalid') ?>"
                }
            },
