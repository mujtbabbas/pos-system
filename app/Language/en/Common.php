...
return [
    ...
    "software_short"                 => "SaleMate POS",
    "software_title"                 => "SaleMate POS",
    "state"                          => "State",
    "submit"                         => "Submit",
    "total_spent"                    => "Total Spent",
    "unknown"                        => "Unknown",
    "view_recent_sales"              => "View Recent Sales",
    "website"                        => "http://www.brenhamstudio.com",
    "welcome"                        => "Welcome",
    "welcome_message"                => "Welcome to SaleMate POS, click a module below to get started.",
    "yes"                            => "Yes",
    "you_are_using_ospos"            => "",
    "zip"                            => "Postal Code",
    'Common.select_payment_option' => 'Select Payment Option',
];
